...
public class PlayerController : MonoBehaviour
{
    ...
    private void Move(Vector2 moveInput)
    {
        ...
        // Multiply the targetRotation Quaternion with Vector 3.forward (not commutative!)
        // to get a direction vector in the direction of the targetRotation
        // In a sense "vectorize the quaternion" (loosing an axis of data: the roll).
    ...
    private void RotateCamera(Vector2 lookInput)
    {
        ...
        // This prevents it from rotating with its parent Player object.
